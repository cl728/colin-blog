        ...
        __proto__: null, escapeHTML: n, inherit: t, nodeStream: function (e) {
            ...
            return function e(t, a) {
                for (var i = t.firstChild; i; i = i.nextSibling) 3 === i.nodeType ? a += i.nodeValue.length : 1 === i.nodeType && (n.push({
                    ...
                    offset: a,
                    node: i
                }), a = e(i, a), r(i).match(/br|hr|img|input/) || n.push({event: "stop", offset: a, node: i}));
                return a
            }(e, 0), n
    ...
    return function (e) {
        ...
        return {
            ...
            contains: [e.COMMENT("///", "$", {
                ...
                illegal: /[^\s:,]/,
                contains: [{beginKeywords: "where class"}, i, {
                    begin: "<",
                    end: ">",
                    keywords: "in out"
                }, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE]
...
hljs.registerLanguage("c-like", function () {
    ...
    return function (e) {
        ...
        var n = "(decltype\\(auto\\)|" + t("[a-zA-Z_]\\w*::") + "[a-zA-Z_]\\w*" + t("<.*?>") + ")",
            ...
            }, c = {className: "title", begin: t("[a-zA-Z_]\\w*::") + e.IDENT_RE, relevance: 0},
            o = t("[a-zA-Z_]\\w*::") + e.IDENT_RE + "\\s*\\(", l = {
        ...
        return {
            ...
            exports: {preprocessor: i, strings: a, keywords: l}
        }
    }
}());
...
hljs.registerLanguage("bash", function () {
    ...
    return function (e) {
        ...
        const n = {className: "subst", begin: /\$\(/, end: /\)/, contains: [e.BACKSLASH_ESCAPE]},
            t = {className: "string", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, s, n]};
        n.contains.push(t);
        const a = {
            begin: /\$\(\(/,
            end: /\)\)/,
        ...
        return {
            ...
            contains: [{className: "meta", begin: /^#![^\n]+sh\s*$/, relevance: 10}, {
                ...
                relevance: 0
            }, a, e.HASH_COMMENT_MODE, t, {className: "", begin: /\\"/}, {className: "string", begin: /'/, end: /'/}, s]
        }
    }
}());
...
hljs.registerLanguage("coffeescript", function () {
    ...
    return function (e) {
        var n = {
            ...
            }, i = "[A-Za-z$_][0-9A-Za-z$_]*", s = {className: "subst", begin: /#\{/, end: /}/, keywords: n},
        ...
        s.contains = a;
        var t = e.inherit(e.TITLE_MODE, {begin: i}), r = {
            className: "params",
            begin: "\\([^\\(]",
            returnBegin: !0,
            contains: [{begin: /\(/, end: /\)/, keywords: n, contains: ["self"].concat(a)}]
        };
        return {
            name: "CoffeeScript",
...
hljs.registerLanguage("ini", function () {
    ...
    return function (e) {
        ...
        var s = {className: "variable", variants: [{begin: /\$[\w\d"][\w\d_]*/}, {begin: /\$\{(.*?)}/}]},
            i = {className: "literal", begin: /\bon|off|true|false|yes|no\b/}, t = {
                className: "string",
                contains: [e.BACKSLASH_ESCAPE],
        ...
        return {
            ...
            contains: [a, {className: "section", begin: /\[+/, end: /\]+/}, {
                ...
                starts: {
                    ...
                    contains: [a, {begin: /\[/, end: /\]/, contains: [a, i, s, t, n, "self"], relevance: 0}, i, s, t, n]
                }
            }]
        }
    }
        ...
        var n = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?", a = {
            ...
            r = [e.COMMENT("#", "$", {contains: [s]}), e.COMMENT("^\\=begin", "^\\=end", {
                ...
                variants: [{begin: /'/, end: /'/}, {begin: /"/, end: /"/}, {begin: /`/, end: /`/}, {
                    ...
                    begin: /<<[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b/,
                    returnBegin: !0,
                    contains: [{begin: /<<[-~]?'?/}, {begin: /\w+/, endSameAsBegin: !0, contains: [e.BACKSLASH_ESCAPE, c]}]
                }]
...
hljs.registerLanguage("yaml", function () {
    ...
    return function (e) {
        ...
        return {
            ...
            }, {className: "number", begin: e.C_NUMBER_RE + "\\b"}, n]
        }
    }
}());
...
hljs.registerLanguage("typescript", function () {
    ...
    return function (e) {
        var n = {
        ...
        }, r = {className: "meta", begin: "@[A-Za-z$_][0-9A-Za-z$_]*"}, a = {
            begin: "\\(",
            end: /\)/,
            keywords: n,
            ...
            relevance: 0
        }, i = {className: "subst", begin: "\\$\\{", end: "\\}", keywords: n, contains: []}, o = {
            begin: "html`",
            end: "",
        ...
        }, E = {className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, i]};
        return i.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, E, s, e.REGEXP_MODE], {
            ...
            contains: [{
                ...
                excludeEnd: !0,
                keywords: n,
                contains: ["self", e.inherit(e.TITLE_MODE, {begin: "[A-Za-z$_][0-9A-Za-z$_]*"}), t],
                illegal: /%/,
                relevance: 0
            }, {beginKeywords: "constructor", end: /[\{;]/, excludeEnd: !0, contains: ["self", t]}, {
                begin: /module\./,
            ...
            }, {begin: /\$[(.]/}, {begin: "\\." + e.IDENT_RE, relevance: 0}, r, a]
        }
    }
}());
...
hljs.registerLanguage("objectivec", function () {
    "use strict";
    return function (e) {
        var n = /[a-zA-Z@][a-zA-Z0-9_]*/, _ = "@interface @class @protocol @implementation";
        return {
            name: "Objective-C",
...
hljs.registerLanguage("javascript", function () {
    "use strict";
    return function (e) {
        var n = {begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/}, a = "[A-Za-z$_][0-9A-Za-z$_]*", s = {
        ...
        var l = i.contains.concat([e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE]),
            d = {className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, contains: l};
        return {
            name: "JavaScript",
